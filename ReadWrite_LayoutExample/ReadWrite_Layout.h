// Layout.h      simple stream read/write layout implementation example
...
#include "ReadWrite_Read.h"
#include "ReadWrite_Write.h"

template<typename ... Objects>
struct Layout
{
	static void Read (std::ifstream& is, Objects      & ... objects)
	{
		return (read(is, objects), ...);
	}

	static void Write(std::ofstream& os, Objects const& ... objects)
	{
